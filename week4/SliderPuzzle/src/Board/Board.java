...
public class Board {
    ...
    public Board twin() {
        ...
        int i = 0, j = 0, swapI = 0,swapJ = 0; 

        while (i == swapI || j == swapJ || tiles[i][j] == 0 || tiles[swapI][swapJ] == 0) {
            i = StdRandom.uniform(twinBoard.n); j = StdRandom.uniform(twinBoard.n);
            swapI = StdRandom.uniform(twinBoard.n); swapJ = StdRandom.uniform(twinBoard.n);
        }
    
        exchangTiles(twinBoard, j, i, swapJ, swapI);
        return twinBoard;
    }
