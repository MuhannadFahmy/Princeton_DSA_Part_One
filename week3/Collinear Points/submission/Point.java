...
public class Point implements Comparable<Point> {
    ...
    public Comparator<Point> slopeOrder() {
        /* YOUR CODE HERE */
        Point x0 = new Point(this.x, this.y);

        final Comparator<Point> com = new Comparator<>() {
            public int compare(final Point p1, final Point p2) {
                if      (x0.slopeTo(p1) < x0.slopeTo(p2))   { return -1; }
                else if (x0.slopeTo(p1) == x0.slopeTo(p2))  { return 0; }
                else                                        { return 1; }
            }
        };
